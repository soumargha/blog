...
{/* Blog1 */}
<section id="blogs" className="bg-white bg-purple-950 mt-12 px-4 py-0 mr-[-1rem]   ">
    <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
        <div className="bg-gray-50 bg-purple-950 border border-gray-200 border-purple-950 rounded-lg p-8 md:p-0 mb-8">
            
            <h1 className="text-gray-900 text-white text-3xl md:text-5xl font-extrabold mb-2 text-center">Explore all my blogs</h1>
            <p className="text-lg font-normal text-gray-500 text-gray-400 mb-6"></p>
        ...
        <div className="bg-gray-50 bg-purple-700 border border-gray-200 border-gray-700 rounded-lg p-8 md:p-12">
        <img
            ...
            />
                ...
                <h2 className="text-gray-900 text-purple-100 text-3xl font-extrabold mb-2">Unveiling Gemini AI:</h2>
                <h1 className="text-lg font-semibold text-gray-500 text-gray-950 focus:font-bold mb-4">Artificial Intelligence (AI) has been a transformative force, pushing the boundaries of what we once deemed possible. In this fast-evolving landscape, a new player has emerged, making waves and capturing the attention of tech enthusiasts and industry experts alike – Gemini AI.</h1>
                <Link 
                onClick={handleReadMoreClick}
                 to="/Blog1"
                className="text-blue-600 text-black hover:underline font-medium text-lg inline-flex items-center">
       <button
       
       className="text-white bg-purple-950 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 bg-purple-950 hover:bg-purple-900 focus:outline-none focus:ring-purple-900"
       type="button"
       ...
       Read more </button>
        ...
        <img
            ...
            />
                ...
                <h2 className="text-gray-900 text-purple-100 text-3xl font-extrabold mb-2">GitHub Copilot:</h2>
        ...
        <svg className="w-3.5 h-3.5 ms-2 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
          <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M1 5h12m0 0L9 1m4 4L9 9" />
            ...
            />
                ...
                <h2 className="text-gray-900 text-purple-100 text-3xl font-extrabold mb-2">Unveiling the Power of Data Analytics:</h2>
          ...
          <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M1 5h12m0 0L9 1m4 4L9 9" />
           ...
           <img
            ...
            />
                ...
                <h2 className="text-gray-900 text-purple-100 text-3xl font-extrabold mb-2">Exploring the MediaTek Dimensity 9300 Chip</h2>
    ...
    <div className="text-center">
      <button
        ...
        type="button"
        className="text-white bg-purple-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-6 py-2.5 text-center me-2  bg-purple-600 hover:bg-blue-700 focus:ring-blue-800 mb-11"
      >
        More Blogs
      </button>
    </div>
