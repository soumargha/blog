  ...
  return (
    <div id='coffee' className="bg-gray-50 dark:bg-black border border-black rounded-lg p-8 md:p-0 mb-32 mt-10 ml-16 mr-16 text-center">
      <a href="#" className="bg-blue-100 text-blue-800 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded-md dark:bg-black dark:text-blue-400 mb-2">
        <img
          src={consulting}
          className="w-32 rounded-lg mx-auto"  // Center the image using mx-auto
          alt="Avatar"
        />
      </a>
      ...
      <button
        className="text-white bg-purple-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 focus:outline-none dark:focus:ring-blue-800"
        type="button"
